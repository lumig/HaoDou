...
@implementation CateTwoTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _cateThreeImgView = [[CateView alloc] initWithFrame:CGRectMake(15, 140, (kSize.width - 30)/2.0f - 5, 160)];
...
{
    if ([_delegate respondsToSelector:@selector(CateTwoTableViewCellDidClicked:)]) {
        [_delegate CateTwoTableViewCellDidClicked:sender.view.tag];
    }
}
